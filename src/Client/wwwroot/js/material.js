...
(function (global, factory) {
    ...
    function requirePicker() {
        if (hasRequiredPicker) return picker.exports;
        hasRequiredPicker = 1;
    ...
    (function (module, exports) {
        (function (factory) {
            ...
            // AMD.
            module.exports = factory(requirePicker(), $__default["default"]);
        ...
        if (targetElement) {
            ...
            if (container2ripplet) {
                if (rippletContainerElement) {
                    ...
                    container2ripplet.forEach(function (r) {
                        return (r.style.opacity = '0');
                    });
                    target2container2ripplet.delete(targetElement);
                }
            }
        } else {
            target2container2ripplet.forEach(function (container2ripplet) {
                return container2ripplet.forEach(function (r) {
                    return (r.style.opacity = '0');
                });
            });
